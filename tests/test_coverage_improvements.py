...
class TestCoverageImprovements:
    ...
    @pytest.mark.asyncio
    async def test_next_with_invalid_input(
        self, sqlite_connection_string, document_type
    ):
    ...
    @pytest.mark.asyncio
    async def test_finish_with_empty_result(
        self, sqlite_connection_string, document_type
    ):
        ...
        empty_type = DocumentType(
            states=[link, download], transitions=[]  # No transitions
        )

        docstore = DocStore(
            connection_string=sqlite_connection_string, document_type=empty_type
        )
