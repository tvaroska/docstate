...
class TestFinalCoverage:
    ...
    @pytest.mark.asyncio
    async def test_process_single_document_with_list_result(self, sqlite_connection_string, document_states):
        ...
        doc_type = DocumentType(
            ...
            transitions=[
                Transition(from_state=link, to_state=download, process_func=list_process)
            ]
        )
